...
\newcommand{\CVTitle}{Zijun Yan's CV for Acme Corporation}
...
\GapNoBreak
\BulletItem
Computer Science with Math option first year undergraduate
\hfill
\DatestampYMD{2016}{10}{1} --
Now
\begin{detail}
\SubBulletItem
ComSci: Digital Electronics, Discrete Mathematics, Foundations of Computer Science, Object-Oriented Programming, Algorithms, Operating Systems, Further Java Briefing, Numerical Methods, Software and Security Engineering. 
\href{}
{}
\SubBulletItem
Math:Vectors and Matrices, Analysis, Differential Equations, Probability in Math.
\end{detail}
...
\SubBulletItem
Project:
An automatic program for taking the stream data from mySQL, converting data to excel representation and sending a email to an email list. 
\SubBulletItem
Skill included: C Sharp, SQL and simple data structure, algorithm.
\end{detail}
...
\GapNoBreak
\BulletItem
Summer Course for A-Level International Student
\hfill
\DatestampYMD{2016}{07}{15} --
\DatestampYMD{2016}{8}{29}
\begin{detail}
\SubBulletItem
Teached Math, Physics, Chemistry and gave suggestions on A-Level Courses. 
\SubBulletItem
